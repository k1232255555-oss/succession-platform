...
未来へ、事業をつなぐ。Succession Club は、後継者不足で消えそうな事業と、事業を引き継いで挑戦したい人をつなぐ、双方向の事業承継マッチングサービスです。
...
クローズドβでは、最初の10社を無料キャンペーンとして扱わず、事業承継の新しい選択肢を一緒に育てる「第1期 Founding Members」の共創枠として案内します。

トップページ下部に以下の補助導線を置いています。

- `/contact?topic=founding-member`: Founding Members参加希望
