...
- Succession Issue Graph 用に、匿名・構造化された承継ブリーフを蓄積
...
Succession Club の中核資産は、承継ブリーフそのものではなく、匿名・構造化された承継論点データです。

目的は、事業承継の現場で「何が話を前に進め、何が止めるのか」を、個人情報を最小化しながら蓄積することです。
...
- `AGGREGATE_ONLY`: 匿名集計にのみ利用します。Succession Issue Graph の主データです。
