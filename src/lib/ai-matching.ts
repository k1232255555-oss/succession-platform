...
export function getFallbackMatch(input: {
  ...
  return {
    ...
    concerns: [
      "具体的な承継課題との一致度は、本人確認、面談、関係者との対話で確認してください。",
    ...
    input: [
      {
        role: "system",
        content:
          "あなたは事業承継プラットフォームの参考分析を支援します。M&A、親族承継、従業員承継を否定せず、候補者プロフィールと承継課題の接点を、実現可能性、現場適応、成長余地、リスクの観点で整理してください。意思決定を代替する表現や誇張を避け、必ず日本語で実務的に返してください。",
      },
      {
        role: "user",
